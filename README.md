...
- **`urlBarMode`** — режим адресной строки. Тип — `AuthBrowserUrlBarMode`. Значение по умолчанию — `AuthBrowserUrlBarMode.hidden`. Подробнее — в разделе «Режимы адресной строки».
